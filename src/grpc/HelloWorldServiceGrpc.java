...
@javax.annotation.Generated(
    ...
    comments = "Source: src/grpc/helloworld.proto")
public class HelloWorldServiceGrpc {

  private HelloWorldServiceGrpc() {}

  public static final String SERVICE_NAME = "grpc.HelloWorldService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<grpc.GetHelloWorldRequest,
      grpc.HelloWorldResponse> METHOD_GET_HELLO_WORLD =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "grpc.HelloWorldService", "GetHelloWorld"),
          io.grpc.protobuf.ProtoUtils.marshaller(grpc.GetHelloWorldRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(grpc.HelloWorldResponse.getDefaultInstance()));
  ...
  public static abstract class HelloWorldServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getHelloWorld(grpc.GetHelloWorldRequest request,
        io.grpc.stub.StreamObserver<grpc.HelloWorldResponse> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_GET_HELLO_WORLD, responseObserver);
    }

    @java.lang.Override public io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            METHOD_GET_HELLO_WORLD,
            asyncUnaryCall(
              new MethodHandlers<
                grpc.GetHelloWorldRequest,
                grpc.HelloWorldResponse>(
                  this, METHODID_GET_HELLO_WORLD)))
          .build();
    }
  }
  ...
  public static final class HelloWorldServiceStub extends io.grpc.stub.AbstractStub<HelloWorldServiceStub> {
    ...
    public void getHelloWorld(grpc.GetHelloWorldRequest request,
        io.grpc.stub.StreamObserver<grpc.HelloWorldResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(METHOD_GET_HELLO_WORLD, getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class HelloWorldServiceBlockingStub extends io.grpc.stub.AbstractStub<HelloWorldServiceBlockingStub> {
    ...
    /**
     */
    public grpc.HelloWorldResponse getHelloWorld(grpc.GetHelloWorldRequest request) {
      return blockingUnaryCall(
          getChannel(), METHOD_GET_HELLO_WORLD, getCallOptions(), request);
    }
  }
  ...
  public static final class HelloWorldServiceFutureStub extends io.grpc.stub.AbstractStub<HelloWorldServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.HelloWorldResponse> getHelloWorld(
        grpc.GetHelloWorldRequest request) {
      return futureUnaryCall(
          getChannel().newCall(METHOD_GET_HELLO_WORLD, getCallOptions()), request);
    }
  }

  private static final int METHODID_GET_HELLO_WORLD = 0;
  ...
  private static class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_HELLO_WORLD:
          serviceImpl.getHelloWorld((grpc.GetHelloWorldRequest) request,
              (io.grpc.stub.StreamObserver<grpc.HelloWorldResponse>) responseObserver);
          break;
        default:
